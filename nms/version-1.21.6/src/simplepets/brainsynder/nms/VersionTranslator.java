...
public class VersionTranslator {
    ...
    static {
        accessor = FieldAccessor.getField(LivingEntity.class, VersionFields.v1_21_6.getAttributesField(), AttributeMap.class);

        try {
            Field jumpingField = LivingEntity.class.getDeclaredField(VersionFields.v1_21_6.getEntityJumpField());
    ...
    public static org.bukkit.entity.Entity getBukkitEntity(Entity entity) {
        org.bukkit.craftbukkit.v1_21_R5.entity.CraftEntity craftEntity = entity.getBukkitEntity();
        return craftEntity;
    }
    ...
    public static void modifyGlowData(SynchedEntityData toCloneDataWatcher, SynchedEntityData newDataWatcher,
        ...
        Int2ObjectMap<SynchedEntityData.DataItem<Byte>> newMap =
                (Int2ObjectMap<SynchedEntityData.DataItem<Byte>>) FieldUtils.readDeclaredField(toCloneDataWatcher,
                        VersionFields.v1_21_6.getEntityDataMapField(), true);
        ...
        FieldUtils.writeDeclaredField(newDataWatcher, VersionFields.v1_21_6.getEntityDataMapField(), newMap, true);
    }
