...
public class VersionTranslator {
    ...
    static {
        accessor = FieldAccessor.getField(LivingEntity.class, VersionFields.v1_21_7.getAttributesField(), AttributeMap.class);

        try {
            Field jumpingField = LivingEntity.class.getDeclaredField(VersionFields.v1_21_7.getEntityJumpField());
    ...
    public static void modifyGlowData(SynchedEntityData toCloneDataWatcher, SynchedEntityData newDataWatcher,
        ...
        Int2ObjectMap<SynchedEntityData.DataItem<Byte>> newMap =
                (Int2ObjectMap<SynchedEntityData.DataItem<Byte>>) FieldUtils.readDeclaredField(toCloneDataWatcher,
                        VersionFields.v1_21_7.getEntityDataMapField(), true);
        ...
        FieldUtils.writeDeclaredField(newDataWatcher, VersionFields.v1_21_7.getEntityDataMapField(), newMap, true);
    }
